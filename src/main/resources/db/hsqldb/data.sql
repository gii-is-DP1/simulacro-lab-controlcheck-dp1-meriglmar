...
-- Se crean todos los productos en la base de datos. Primero los productType y luego los productos,
-- ya que en el siguiente ejercicio (TEST 4) dará error si se disponen al contrario.
